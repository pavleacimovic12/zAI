...
def main():
    ...
    if not st.session_state.messages:
        ...
        <div class="welcome-section">
            ...
            <div class="topic-buttons">
                <div class="topic-btn">Clinical Trials</div>
                <div class="topic-btn">FDA Regulations</div>
                <div class="topic-btn">GCP Guidelines</div>
                <div class="topic-btn">Medical Research</div>
                <div class="topic-btn">Drug Information</div>
                <div class="topic-btn">Safety Reporting</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        send_button = st.button("✈️", type="primary", help="Send message")
    
    with col3:
        if st.button("🗑️ Clear Chat", help="Clear conversation"):
            st.session_state.messages = []
            st.rerun()
